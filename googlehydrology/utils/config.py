...
class Config(object):
    ...
    @property
    def statics_data_path(self) -> Path:
        return self.statics_data_dir
    ...
    @property
    def targets_data_path(self) -> Path:
        return self.targets_data_dir

    @property
    def dynamics_data_path(self) -> Path:
        return self.dynamics_data_dir
