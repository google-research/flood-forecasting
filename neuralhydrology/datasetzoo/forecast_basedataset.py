...
class ForecastDataset(BaseDataset):
    ...
    def _extract_hindcasts(self, item: int) -> dict[str, np.ndarray]:
        ...
        features = self._extract_dataset(self._dataset, self._hindcast_features_without_lead_time, dim_indexes)
        ...
        dim_indexes['date'] = range(dim_indexes['date'].start-1, dim_indexes['date'].stop-1, dim_indexes['date'].step)
        features |= self._extract_dataset(self._dataset, self._hindcast_features_with_lead_time, dim_indexes)
